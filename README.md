...
動作確認の録画(約1MB、WebM形式)。支出を登録していくと、背景が通常色→薄い赤→濃い赤と切り替わり、そのあと入力エラー・編集の画面に進みます。
[pPiv-RU_7ZnRhxCZ1IOyoQ.webm](https://github.com/user-attachments/assets/850e13ed-268e-4751-b891-49a7be148dc3)
